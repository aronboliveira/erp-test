...
echo -e "  ${CYAN}🗄  PostgreSQL${NC}      → ${GREEN}localhost:5433${NC}  (acmedb / postgres / postgres)"
echo -e "  ${CYAN}☕ Backend API${NC}      → ${GREEN}http://localhost:8082${NC}"
echo -e "  ${CYAN}🌐 Admin Dashboard${NC}  → ${GREEN}http://localhost:4001${NC}"
echo ""
...
echo -e "  ${CYAN}Health Check${NC}        → ${GREEN}http://localhost:8082/actuator/health${NC}"
echo -e "  ${CYAN}Swagger UI${NC}          → ${GREEN}http://localhost:8082/swagger-ui.html${NC} ${YELLOW}(if enabled)${NC}"
echo ""

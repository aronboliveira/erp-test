...
import { ObjectMapper } from './object-mapper.adapter';
...
export const HTTPResSuccessfulMap = ObjectMapper.deepFreeze(
  new Map<number, ResponseLanguage<HTTPResponseSuccessfulLabelPt, HTTPResponseSuccessfulLabelEn>>([
...
export const HTTPResRedirectMap = ObjectMapper.deepFreeze(
  new Map<number, ResponseLanguage<HTTPResponseRedirectLabelPt, HTTPResponseRedirectLabelEn>>([
...
export const HTTPResClientErrorMap = ObjectMapper.deepFreeze(
  new Map<number, ResponseLanguage<HTTPResponseClientErrorLabelPt, HTTPResponseClientErrorLabelEn>>(
    [
...
export const HTTPResServerErrorMap = ObjectMapper.deepFreeze(
  new Map<number, ResponseLanguage<HTTPResponseServerErrorLabelPt, HTTPResponseServerErrorLabelEn>>(
    [
      [
        500,
        {
...
export const HTTPRes = ObjectMapper.deepFreeze({
  info: HTTPResInfoMap,
